<template>
    ...
    <div class="flex flex-col justify-center w-full pt-6 text-center rounded-sm">
		<h1 class="text-5xl font-bold leading-none sm:text-6xl mb-2 dark:text-violet-600">Ac mattis erat pharetra</h1>
      ...
      <div class="grid max-w-screen-lg gap-8 row-gap-5 md:row-gap-8 sm:mx-auto lg:grid-cols-2">
        <div class="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
          ...
          <div class="px-6 py-8 border border-t-0 rounded-b sm:px-8">
            ...
            <button
              type="submit"
              class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white dark:bg-violet-600 transition duration-200 rounded shadow-md b hover:bg-gray-700 focus:shadow-outline focus:outline-none"
            >
              Read more
            </button>
          </div>
        ...
        <div class="transition duration-300 transform bg-white rounded shadow-sm hover:-translate-y-1 hover:shadow md:text-center">
          ...
          <div class="px-6 py-8 border border-t-0 rounded-b sm:px-8">
            ...
            <button
              type="submit"
              class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white dark:bg-violet-600 transition duration-200 rounded shadow-md bg-deep-purple-accent-400 hover:bg-gray-700 focus:shadow-outline focus:outline-none"
            >
              Read more
            </button>
          </div>
