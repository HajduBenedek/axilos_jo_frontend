<template>
    <div class="relative mt-16 bg-purple-700">
      <svg class="absolute top-0 w-full h-6 -mt-5 sm:-mt-10 sm:h-16 text-purple-700" preserveAspectRatio="none" viewBox="0 0 1440 54">
